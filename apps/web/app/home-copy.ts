...
export const HOME_COPY = {
  ...
  howItWorksOutcome:
    "Hangi yolu seçersen seç, sonuçlarda aynı ve benzer ürünleri inceleyebilir, farklı mağaza tekliflerini ve stok durumunu karşılaştırabilirsin.", // home.how_it_works_outcome
  trustTitle: "Karar vermene nasıl yardımcı oluyoruz", // home.trust_title
  trustPointAlternatives:
    "Aynı ürünü veya görsel ve metin olarak benzer alternatiflerini bulursun.", // home.trust_point_alternatives
  trustPointCompare:
    "Farklı mağazalardaki teklifleri kargo dahil toplam fiyata ve stok durumuna göre karşılaştırırsın.", // home.trust_point_compare
  trustPointFreshness:
    "Fiyat ve stok bilgisi doğrudan mağaza kaynaklarından gelir, güncellenme zamanıyla birlikte gösterilir.", // home.trust_point_freshness
  trustPointCommission:
    "Bazı mağaza bağlantılarından komisyon kazanabiliriz. Bu, gösterilen fiyatı değiştirmez; sıralamada komisyon belirleyici değildir.", // home.trust_point_commission
  trustPointAlternativesTitle: "Aynı ve benzer ürünler", // home.trust_point_alternatives_title
  trustPointCompareTitle: "Mağazaları karşılaştır", // home.trust_point_compare_title
  trustPointFreshnessTitle: "Kaynağı ve zamanı belli", // home.trust_point_freshness_title
  trustPointCommissionTitle: "Açık komisyon bildirimi", // home.trust_point_commission_title
  kesfetDescription: "Farklı kategorilerden bugün öne çıkan ürünler.", // discover.description
  kesfetCuratedTitle: "Bugün öne çıkanlar", // discover.curated_title
  kesfetOrganicTitle: "Kullanıcıların bulduğu", // discover.organic_title
  kesfetEmptyTitle: "Bugünlük içerik hazırlanıyor.", // empty.discovery
  kesfetEmptyDescription:
    "Bu sırada aradığın ürünü yazarak ya da fotoğrafını yükleyerek başlayabilirsin.", // empty.discovery_description
  kesfetEmptyAction: "Aramaya başla", // empty.discovery_action
  ...
  priceDisclaimer: "Fiyat ve stok bilgisi mağazalardan alınır, gecikmeli olabilir.", // legal.price_disclaimer
} as const;
